...
public class ToggleManager {
    ...
    public ToggleManager(Context c) {
        ...
        mSoundObserver = new SoundObserver(new Handler());
        mSoundObserver.observe();
    ...
    private void updateToggleList() {
        ...
        for (String toggleIdent : toots) {
            try {
                ...
                toggle.setControllers(bluetoothController, networkController, batteryController,
                        locationController, brightnessController);
                mToggles.add(toggle);
                ...
                if (locationController != null && toggle instanceof LocationSettingsChangeCallback) {
                    locationController
                            .addSettingsChangedCallback((LocationSettingsChangeCallback) toggle);
                }
